...
class Card:
    ...
    def __gt__(self, other: Card) -> bool:
        if (not self.is_trump) and (not other.is_trump) and (self.suit != other.suit):
            return ValueError("Cant campare not trump cards with different suites")
